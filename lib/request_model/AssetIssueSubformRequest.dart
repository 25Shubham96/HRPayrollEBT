...
AssetIssueSubformRequest assetIssueSubformRequestFromJson(String str) =>
    AssetIssueSubformRequest.fromJson(json.decode(str));

String assetIssueSubformRequestToJson(AssetIssueSubformRequest data) =>
...
class AssetIssueSubformRequest {
  ...
  factory AssetIssueSubformRequest.fromJson(Map<String, dynamic> json) =>
      AssetIssueSubformRequest(
        action: json["Action"],
