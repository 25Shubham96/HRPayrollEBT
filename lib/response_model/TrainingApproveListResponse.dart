...
TrainingApproveListResponse trainingApproveListResponseFromJson(String str) =>
    TrainingApproveListResponse.fromJson(json.decode(str));

String trainingApproveListResponseToJson(TrainingApproveListResponse data) =>
...
class TrainingApproveListResponse {
  ...
  factory TrainingApproveListResponse.fromJson(Map<String, dynamic> json) =>
      TrainingApproveListResponse(
        status: json["status"],
        message: json["message"],
        data: List<TrainingApproveListModel>.from(
            json["data"].map((x) => TrainingApproveListModel.fromJson(x))),
      );
...
class TrainingApproveListModel {
  ...
  factory TrainingApproveListModel.fromJson(Map<String, dynamic> json) =>
      TrainingApproveListModel(
