...
PassportRetentionLedgerResponse passportRetentionLedgerResponseFromJson(
        String str) =>
    PassportRetentionLedgerResponse.fromJson(json.decode(str));

String passportRetentionLedgerResponseToJson(
        PassportRetentionLedgerResponse data) =>
...
class PassportRetentionLedgerResponse {
  ...
  factory PassportRetentionLedgerResponse.fromJson(Map<String, dynamic> json) =>
      PassportRetentionLedgerResponse(
        status: json["status"],
        message: json["message"],
        data: List<PassportRetentionLedgerModel>.from(
            json["data"].map((x) => PassportRetentionLedgerModel.fromJson(x))),
      );
...
class PassportRetentionLedgerModel {
  ...
  factory PassportRetentionLedgerModel.fromJson(Map<String, dynamic> json) =>
      PassportRetentionLedgerModel(
