...
AssetIssueResponse assetIssueResponseFromJson(String str) =>
    AssetIssueResponse.fromJson(json.decode(str));

String assetIssueResponseToJson(AssetIssueResponse data) =>
...
class AssetIssueResponse {
  ...
  factory AssetIssueResponse.fromJson(Map<String, dynamic> json) =>
      AssetIssueResponse(
        status: json["status"],
        message: json["message"],
        data: List<AssetIssueModel>.from(
            json["data"].map((x) => AssetIssueModel.fromJson(x))),
      );
