...
class EmployeeAssetSanction extends StatelessWidget {
  String EmpNo;

  EmployeeAssetSanction(this.EmpNo);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: MyAppBar.getAppBar("Employee Asset Sanction (${EmpNo})"),
      body: Scrollbar(
        child: ListView(
          children: <Widget>[
            FutureBuilder(
              future: _apiInterface
                  .employeeAssetSanctionResponseData(actionRequest),
